...
function App() {
  ...
  const [auditMode, setAuditMode] = useState<'address' | 'code'>('address');

  // Use the audit hook
  const { auditState, auditContractByAddress, auditContract, clearAudit } = useAudit();
        ...
        <div className="hero-content">
          ...
          <div className="contract-input-card">
            <div className="card-header">
              ...
              <p>Enter your contract address or source code for instant AI-powered analysis</p>
            </div>
            ...
            <div className="input-container">
              ...
              <div className="audit-mode-selector">
                ...
                <div className="mode-buttons">
                  <button
                    className={`mode-button ${auditMode === 'address' ? 'active' : ''}`}
                    onClick={() => setAuditMode('address')}
                  >
                    📍 By Address
                  </button>
                  <button
                    className={`mode-button ${auditMode === 'code' ? 'active' : ''}`}
              ...
              {auditMode === 'address' ? (
                ...
                <div className="contract-code-wrapper">
              ...
              <button
                ...
                onClick={handleScan}
                disabled={auditState.isLoading || (auditMode === 'address' ? !contractAddress : !contractCode)}
              >
                {auditState.isLoading ? (
                  <>
                    <span className="spinner"></span>
                    <span>Analyzing Contract... ({auditState.progress}%)</span>
                  </>
                ) : (
                  <>
          ...
          <div className="demo-widget">
            ...
            <div className="audit-progress">
              <div className="progress-bar">
                <div className="progress-fill" style={{width: `${auditState.progress}%`}}></div>
              </div>
              <span className="progress-text">
                {auditState.isLoading ? `Analyzing contract... ${auditState.progress}%` : 'Ready to scan'}
              </span>
            </div>
      ...
      {auditState.error && (
        <div className="error-overlay">
          <div className="error-modal">
            ...
            <button onClick={() => clearAudit()}>Close</button>
          </div>
        </div>
      )}
    </div>
